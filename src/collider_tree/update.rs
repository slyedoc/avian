...
impl<C: AnyCollider> Plugin for ColliderTreeUpdatePlugin<C> {
    fn build(&self, app: &mut App) {
        ...
        // MovedProxies, EnlargedProxies, and LastDynamicKinematicAabbUpdate are on the PhysicsWorld entity.
...
fn clear_moved_proxies(mut worlds: Query<(&mut MovedProxies, &mut ColliderTrees), With<PhysicsWorld>>) {
